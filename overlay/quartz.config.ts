    ...
    theme: {
      ...
      colors: {
        lightMode: {
          ...
          darkgray: "#5c6a72",                      // --tx1
          dark: "#5c6a72",                          // --tx1
          secondary: "hsl(19, 71%, 58%)",           // --accent
          tertiary: "hsl(16, 72%, 49%)",            // --accent(h - 3, s * 1.02, l * 0.85)
        ...
        darkMode: {
          ...
          //darkgray: "#d3c6aa",                     // --tx1
          //dark: "#d3c6aa",                         // --tx1
          //secondary: "hsl(17, 69%, 68%)",          // --accent
          //tertiary: "hsl(14, 70%, 58%)",           // --accent(h - 3, s * 1.02, l * 0.85)
